...
@Document(collection = "ClientFailure")
public class ClientFailure
{
    ...
    public ClientFailure(LocalDateTime entryTimeStamp, String request_id, String request_type, HttpStatus status, String request, String responseError, String message, String path) {
