...
@Document(collection = "AgentSuccess")
public class AgentSuccess
{
    ...
    public AgentSuccess(LocalDateTime entryTimeStamp, String request_Id, String request_Type, String request, String response, LocalDateTime exitTimeStamp) {
