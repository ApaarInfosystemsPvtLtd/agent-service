...
@Document(collection = "UserAgentCreateRequest")
public class AgentCreateRequestDTO
{
    ...
    private String  accountPayee="          "; //length=10(accountPayees = client No)
    private	String	bcmtab="    ";
    private	String	bctind=" ";
    private	String	clnsel="          ";//As discussed Default value.('25056525  ')
    ...
    private	String	dtetrm="99999999";//As discussed Default value.(8 '9's)
    private	String	excagr="Y";//As discussed Default value.('N')
    private	String	minimumAmount="00000000000000000";//As discussed Default value.(17 '0's)
    private	String	ocmtab="     ";//As discussed Default value.('BA01 ')
    private	String	ovcpc="00000"; //As discussed Default value.(5 '0's)
    ...
    private	String	tagd="X";
    private	String	tagsusind=" ";
    private	String	licenceNumber="               ";
    private	String	licenceExpiryDate="20991231";//As discussed Default value.('20991231')
    ...
    private	String	taxalw="00000000000000000+";//18 character
    private	String	taxcde="  ";
    private	String	taxmeth="ST";
    private	String	tcolmax="00000000000000+";//15 character
    ...
    private String 	natlty="IND";//Default "01 ".
    ...
    public void setAccountPayee(String accountPayee) {
        this.accountPayee = formatStringLength(accountPayee,10);
        this.paysel=this.accountPayee;
    }
    ...
    public void setdateOfAppointment(String dateOfAppointment) {
        ...
        //this.licenseIssuanceDate = this.dateOfAppointment;
    }
    ...
    public void setMinimumAmount(String minimumAmount) {
        this.minimumAmount = formatStringLengthPadLeft(minimumAmount,17);
    }
    ...
    public void setPayflag(String payflag) {
        this.payflag = formatStringLength(payflag,1);
    }
    ...
    */
    ...
    public void setCertificateNumber(String certificateNumber) {
        this.licenceNumber = formatStringLength(certificateNumber,15);
    }
    ...
    public void setClientphone(String clientphone) {
        this.clientphone = formatStringLength(clientphone,16);
    }
    ...
    public void setClntfthr(String clntfthr) {
        this.clntfthr = formatStringLength(clntfthr,60);
    }
    ...
    public void setCltdobx1(String cltdobx1) {
        this.cltdobx1 = cltdobx1;
    }
    ...
    public void setCltpcode1(String cltpcode1) {
        this.cltpcode1 = formatStringLength(cltpcode1,10);
    }
    ...
    public void setLgivname1(String lgivname1) {
        this.lgivname1 = lgivname1;
    }
    ...
    public void setLsurname1(String lsurname1) {
        this.lsurname1 = lsurname1;
    }
    ...
    public void setRtaxidnum(String rtaxidnum) {
        this.rtaxidnum = formatStringLength(rtaxidnum,10);
    }
    ...
    public void setMdfname(String mdfname) {
        this.mdfname = formatStringLength(mdfname,50);
    }
    ...
    public void setMdlname(String mdlname) {
        this.mdlname = formatStringLength(mdlname,50);
    }
    ...
    public void setMdmname(String mdmname) {
        this.mdmname = formatStringLength(mdmname,50);
    }
    ...
    public void setMdsalut(String mdsalut) {
        this.mdsalut = formatStringLength(mdsalut,6);
    }
    ...
    public boolean equals(Object o) {
        ...
        AgentCreateRequestDTO that = (AgentCreateRequestDTO) o;
