...
public class AgentModificationMessageHeader
{
    private String MSGID="AGNMODI   ";  // 10 Character
    ...
    public boolean equals(Object o) {
        ...
        AgentModificationMessageHeader that = (AgentModificationMessageHeader) o;
    ...
    public String toJson() {
        return "AgentModificationMessageHeader{" +
                "MSGID='" + MSGID + '\'' +
                ", MSGLNG='" + MSGLNG + '\'' +
                ", MSGCNT='" + MSGCNT + '\'' +
                ", FILLER='" + FILLER + '\'' +
