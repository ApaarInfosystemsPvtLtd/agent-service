...
@Document(collection = "ClientMODPRequest")
public class ClientMODPMessageBodyRequestDTO
{
    ...
    private String 	natlty="01 ";//As Discussed Default value.('01 ')
    ...
    private	String 	rmblphone="                ";//As Discussed Default value.(10,'9's)
    ...
    public boolean equals(Object o) {
        ...
        ClientMODPMessageBodyRequestDTO that = (ClientMODPMessageBodyRequestDTO) o;
