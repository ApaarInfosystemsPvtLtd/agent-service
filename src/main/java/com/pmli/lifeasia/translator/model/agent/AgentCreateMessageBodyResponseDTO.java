...
public class AgentCreateMessageBodyResponseDTO
{
    ...
    public boolean equals(Object o) {
        ...
        AgentCreateMessageBodyResponseDTO that = (AgentCreateMessageBodyResponseDTO) o;
    ...
    public String toString() {
        return "AgentCreateMessageBodyResponseDTO{" +
                "agnum='" + agnum + '\'' +
                ", state='" + state + '\'' +
                ", message='" + message + '\'' +
                '}';
