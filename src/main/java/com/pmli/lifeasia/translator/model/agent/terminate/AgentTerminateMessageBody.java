package com.pmli.lifeasia.translator.model.agent.terminate;
...
public class AgentTerminateMessageBody {
    ...
    */
    private String ZAGNTSTS="TERM";
    private String STATCHANGEDATE=dateformatter();

    public AgentTerminateMessageBody(String AGNTSEL, String DTETRM,String PAYFLAG) {
        this.AGNTSEL = formatStringLength(AGNTSEL,10);
        this.DTETRM = formatString(DTETRM);
        //this.PAYFLAG = payFlagFormat(PAYFLAG);
    ...
    public boolean equals(Object o) {
        ...
        AgentTerminateMessageBody that = (AgentTerminateMessageBody) o;
    ...
    /*private String payFlagFormat(String message){
