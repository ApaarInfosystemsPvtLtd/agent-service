...
public class ClientCRPMessageBody
{
    private String 	ACTION=	" "	;
    private String 	CLTDBOX="        ";
    private String 	CLTPCODE="          ";
    private String 	CLTPHONE="                ";
    private String 	CONFIRM=" ";
    private String 	LGIVNAME="                                                            ";//60
    private String 	LSURNAME="                                                            ";//60
    private String 	ORTAXIDNUM="          "	;
    private String 	CLNTFTHR="                                                            "	;//60
    private String 	ADDRTYPE=" "	;
    private String 	BIRTHP="                    "	;
    private String 	CLTADDR01="                              "	;//30
    private String 	CLTADDR02="                              "	;//30
    private String 	CLTADDR03="                              "	;//30
    private String 	CLTADDR04="                              "	;//30
    private String 	CLTADDR05="                              "	;//30
    private String 	CLTDOBX="        "	;
    private String 	CLTDODX="        "	;
    ...
    public String getCLTDBOX() {
        return CLTDBOX;
    }

    public void setCLTDBOX(String CLTDBOX) {
        this.CLTDBOX = CLTDBOX;
    }
    ...
    public String getZCKYCDIST() {
        return ZCKYCDIST;
    }

    public void setZCKYCDIST(String ZCKYCDIST) {
        this.ZCKYCDIST = ZCKYCDIST;
    }
    ...
    public String getZCKYNDIST() {
        return ZCKYNDIST;
    }

    public void setZCKYNDIST(String ZCKYNDIST) {
        this.ZCKYNDIST = ZCKYNDIST;
    }
    ...
    public String getZCKYDIST() {
        return ZCKYDIST;
    }

    public void setZCKYDIST(String ZCKYDIST) {
        this.ZCKYDIST = ZCKYDIST;
    }
    ...
    public boolean equals(Object o) {
        ...
        ClientCRPMessageBody that = (ClientCRPMessageBody) o;

        return new EqualsBuilder()
                .append(getACTION(),that.getACTION())
                .append(getCLTDBOX(),that.getCLTDBOX())
                .append(getCLTPCODE(),that.getCLTPCODE())
                .append(getCLTPHONE(),that.getCLTPHONE())
                ...
                .append(getZCKYCDIST(),that.getZCKYCDIST())
                ...
                .append(getZCKYNDIST(),that.getZCKYNDIST())
                ...
                .append(getZCKYDIST(),that.getZCKYDIST())
